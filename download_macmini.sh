...
# Mac Mini — downloads p14, p15, p16 (113,546 files)

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
BASE_URL="https://physionet.org/files/mimic-cxr-jpg/2.1.0"
SHA256_FILE="$SCRIPT_DIR/SHA256SUMS_macmini.txt"
ARIA2_INPUT="$SCRIPT_DIR/aria2_input_macmini.txt"
DOWNLOAD_DIR="${1:-.}"
